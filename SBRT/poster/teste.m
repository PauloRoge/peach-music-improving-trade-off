...
parfor k = 1:nsnr
    ...
    for r = 1:MCS
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        tic;                                              % cronômetro
        [~, ~, est_peach1] = peach_analitico( ...
            Yh, Yv, L, x, 96, x_h, z_h, x_v, z_v, ...
            ref, lambda, y, 48, pos);
        t_pc1 = t_pc1 + toc;
        tic;                                              % cronômetro
        [~, ~, est_peach2] = peach_analitico( ...
            Yh, Yv, L, x, 192, x_h, z_h, x_v, z_v, ...
            ref, lambda, y, 98, pos);
        t_pc2 = t_pc2 + toc;
        tic;                                              % cronômetro
        [~, ~, est_peach3] = peach_analitico( ...
        ...
        % ---------- Nelder-Mead ------------------------------------------
        tic;
        est_nm = nelder_mead(URA, est_peach1, Un, lambda, ref, ...
...
legend('PEACH, N_H=24, N_C=12','PEACH, N_H=96, N_C=48','PEACH, N_H= 192, N_C=98', ...
    'PEACH, N_H=960, N_C=480','PEACH + Nelder-Mead,N_H=96, N_C=48','Golden PEACH, N_H=24, N_C=12', ...
    'CRB','Location','best');
