...
% ---------- 2. Varredura de SNR -----------------------------------------
SNR_dB_vec = 0:0.5:20;                   % passo de 2 dB para reduzir tempo
...
MSE_golden1= zeros(1,nsnr);
MSE_golden2= zeros(1,nsnr);
...
parfor k = 1:nsnr
    ...
    for r = 1:MCS
        ...
        alpha, SNRdB, P_tx, Mx, Mz, K_dB, scatterer_pos, Gamma);
    ...
    % MSE_nm(k)     = sqrt(err2_nm / MCS);
    MSE_golden(k) = err2_gd / MCS;
    MSE_golden1(k) = err2_gd1 / MCS;
    MSE_golden2(k) = err2_gd2 / MCS;
