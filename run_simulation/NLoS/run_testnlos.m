...
K_dB = 2;  % Rician K (em dB) – aqui 0 dB: LoS e NLoS
...
[Un_h, Un_v, est_peach] = peach_golden_r( ...
    Yh, Yv, L, x, n_hiper, x_h, z_h, x_v, z_v, ...
    ref, lambda, y, n_circ, UEs); 
...
% -------------------------------------------------------------
% PSEUDOESPECTRO MUSIC (retorna handle e Un)
% -------------------------------------------------------------
...
% -------------------------------------------------------------
% Avaliação do pseudoespectro em um ponto 3D
% -------------------------------------------------------------
